...
SCROLL_PAUSE_MS         = 2500 # ms to pause at start/end of each line 3 (aircraft model) scroll cycle
SCROLL_SPEED_PX_PER_SEC = 10 # marquee speed for line 3 when the aircraft model overflows the display
